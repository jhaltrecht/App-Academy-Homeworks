...
# re-factor CorgiSnacks into the new MetaCorgiSnacks class
  # #send to call methods on your @snack_box. 
  # You can interpolate to get the method name, and then pass the method name to #send

  # def method_missing(name, *args)
  #   # name initially symbol so turning into string
  #   name=name.to_s
