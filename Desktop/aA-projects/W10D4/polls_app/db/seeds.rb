...
Response.create!(answer_choice: a,respondent: u)
Response.create!(answer_choice: a2,respondent: u2)
Response.create!(answer_choice: a3,respondent: u3)
Response.create!(answer_choice: a4,respondent: u4)
